...
class myCharts {
  constructor(defaultParam) {
    ...
    // 扩展或者覆盖配置
    this.defaultParam = utils.extendObj(this.defaultConfig, this.defaultParam)
  ...
  init() {
    switch (this.defaultParam.type) {
      case 'cirque':
        ...
        this.circleConfig = utils.extendObj(this.defaultConfig, circleConfig)
